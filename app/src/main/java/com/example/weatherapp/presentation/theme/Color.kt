...
val AQI_Green = Color(0xFF4CAF50)
val AQI_Yellow = Color(0xFFFFEB3B)
val AQI_Orange =Color(0xFFFF9800)
val AQI_Red = Color(0xFFFF0000)
val AQI_RedDark = Color(0xFF6D0000)
